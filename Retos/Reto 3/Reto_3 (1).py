...
data_covid = pd.read_csv("C:\\Users\\julio\\Downloads\\covid_19_bog (1).csv", encoding='cp1252', sep=';')
...
plt.show()
#Calculo de errores
datos_error_dp = pd.read_csv("C:\\Users\\julio\\Downloads\\datosErrorDP.csv", encoding='cp1252', sep=';')
...
print("Error Relativo Presas RK = {}% ".format(errorRelativoPresa))
...
print("Error Relativo Presas Euler = {}% ".format(errorRelativoPresa))
